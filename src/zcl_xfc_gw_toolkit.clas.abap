CLASS zcl_xfc_gw_toolkit DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS invalidate_client_caches
    ...
    CLASS-METHODS cleanup_metadata_cache
      IMPORTING it_identifier TYPE tt_identifier
      RAISING   zcx_xfc_toolkit_error.

    CLASS-METHODS app_index_calculate
      IMPORTING iv_repository TYPE /ui5/ui5_repository_ui OPTIONAL
      RAISING   zcx_xfc_toolkit_error.

    CLASS-METHODS invalidate_backend_contexts
      RAISING zcx_xfc_toolkit_error.

    CLASS-METHODS clear_metadata_cache
